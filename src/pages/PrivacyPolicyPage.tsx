...
const PrivacyPolicyPage = () => (
  <Styled.Article>
    ...
    <p>
      ...
      used herein refers to that person on whose behalf the Services are used (e.g., an employer).
      If the person engaging with our Services is an individual, acting in their own individual
      capacity, then “user” and “you” (and its variants) refers to that individual. If you have
      anyone using the Services on your behalf, you agree that you are responsible for the actions
    ...
    <ul>
      ...
      <li>
        ...
        through services made available on the Services, such as the type of transaction,
    ...
    <ul>
      ...
      <li>
        ...
        preferences, track the use of the Services, including our mobile applications, and collect
        information about the use of the Services, as well with other information we collect about
        you. You may choose to set your web browser to refuse cookies, or to alert you when cookies
        are being sent. If you do so, please note that some parts of the Services may not function
        properly.
      </li>
    </ul>
    ...
    <p>
      ...
      <ul>
        ...
        <ul>
          ...
          <li>
            perform internal operations necessary to provide the Services, including to troubleshoot
        ...
        <li>
          ...
          experience and use of the Services and our communications. We may also use your
        ...
        <li>
          ...
          the Services and other products and services to you. This may include sending you
          communications about the Services, features, promotions, surveys, news, updates, and
    ...
    <p>
      You have certain data protection rights under the applicable data protection law, including
      the following:
      <ol>
        <li>
        ...
        <li>
          You have the right to be informed of a personal data breach (unless the breach is unlikely
    ...
    <p>
      ...
      websites. If you choose to use those websites, please check the legal and privacy statements
      posted on each website, mobile application or the online asset you access to understand their
      privacy practices. We have no control over and assume no responsibility for the content,
    ...
    <p>
      We may use these technologies to improve your experience when you browse or use the Services,
    ...
    <p>
      ...
      <ul>
        <li>
          <b>Strictly necessary cookies</b>: These cookies are necessary for the Services to
          function and cannot be switched off in our systems. They may allow us to enable security,
          prevent fraud and debug the Services and are usually only set in response to actions made
          by you which amount to a request for use of the Services, such as setting your privacy
        ...
        <li>
          <b>Functional cookies</b>: These are used to recognize you when you return to the
          Services. This may enable us to personalize our content for you and remember your
          preferences.
        </li>
        <li>
    ...
    <p>
      ...
      close your web browser. The cookies placed through your use of the Services are either set by
    ...
    <p>
      ...
      note that cookies are important to many aspects of the Services. If you disable certain
      cookies, you may not be able to enjoy all features of the Services.
      <ul>
        <li>
